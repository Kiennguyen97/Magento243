...
class LayoutProcessor
{
    ...
    public function generateFieldPayment($code, $label, $paymentGroup, $groupConfig, $sortOrder){
        ...
        ['payment']['children']['payments-list']['children'][$paymentGroup]['children']['form-fields']['children'][$code] = [
            ...
            'config' => [
                'customScope' => $code != 'company' ? $groupConfig['dataScopePrefix'].'.custom_attributes' : '',
                'template' => 'ui/form/field',
                'elementTmpl' => 'ui/form/element/input',
                'id' => $code,
            ],
            'dataScope' =>  $code != 'company' ? $groupConfig['dataScopePrefix'] . '.custom_attributes.'.$code : $groupConfig['dataScopePrefix'] . '.'.$code,
            'label' => __($label),
    ...
    public function generateFieldShipping($code, $label, $sortOrder){
        ...
        ['shippingAddress']['children']['shipping-address-fieldset']['children'][$code] = [
            ...
            'config' => [
                ...
                'customScope' =>  $code != 'company' ? 'shippingAddress.custom_attributes': '',
                'customEntry' => null,
                'template' => 'ui/form/field',
                'elementTmpl' => 'ui/form/element/input'
            ],
            'dataScope' => $code != 'company' ? 'shippingAddress.custom_attributes' . '.' . $code : 'shippingAddress' . '.' . $code ,
            'label' => $label,
            'provider' => 'checkoutProvider',
            'sortOrder' => $sortOrder,
            'options' => [],
